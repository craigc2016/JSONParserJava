...
public class DublinCounty extends County {
	...
	public void getInfo(){
		...
		try{
			...
			JSONArray array = (JSONArray) jsonObject.get("Dublin");
	...
	public void setDetailHotel(int index){
		...
		try{
			...
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("DublinHotels");
	...
	public void setDetailR(int index){
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("DublinRestaurants");
	...
	public void setDetailP(int index){
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("DublinPlaces");
	...
	public void setDetailT(int index) {
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("DublinThings");
