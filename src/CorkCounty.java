...
public class CorkCounty extends County {
	...
	public void getInfo(){
		...
		try{
			...
			JSONArray array = (JSONArray) jsonObject.get("Cork");
	...
	public void setDetailHotel(int index){
		...
		try{
			...
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("CorkHotels");
	...
	public void setDetailR(int index){
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("CorkRestaurants");
	...
	public void setDetailP(int index){
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("CorkPlaces");
	...
	public void setDetailT(int index) {
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("CorkThings");
