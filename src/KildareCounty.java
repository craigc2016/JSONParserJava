...
public class KildareCounty extends County {
	...
	public void getInfo(){
		...
		try{
			...
			JSONArray array = (JSONArray) jsonObject.get("Kildare");
	...
	public void setDetailHotel(int index){
		...
		try{
			...
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("KildareHotels");
	...
	public void setDetailR(int index){
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("KildareRestaurants");
	...
	public void setDetailP(int index){
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("KildarePlaces");
	...
	public void setDetailT(int index) {
		...
		try{
			...
			Object obj = parser.parse(new FileReader(file));
			JSONObject jsonObject = (JSONObject) obj;
			JSONArray array = (JSONArray) jsonObject.get("KildareThings");
